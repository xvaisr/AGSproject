...
public class WorldModel extends GridWorldModel
{
  ...
  public int movesPerRound(int agId)
  {
    switch (agId)
    {
      ...
      case 3: return 1;
      case 4: return 2;
      case 5: return 3*agSuperability[2];
      default: return -1;
    }
  }
...
/*    Random random = new Random();
 ...
 /*   Random random = new Random();
  ...
  static WorldModel world3() throws Exception
  {
    ...
    model.add(WorldModel.OBSTACLE, 15, 15);
    model.add(WorldModel.OBSTACLE, 16, 15);
    model.add(WorldModel.OBSTACLE, 17, 15);
    model.add(WorldModel.OBSTACLE, 18, 15);
    model.add(WorldModel.OBSTACLE, 19, 15);
    model.add(WorldModel.OBSTACLE, 20, 15);
    model.add(WorldModel.OBSTACLE, 21, 15);
    model.add(WorldModel.OBSTACLE, 22, 15);
    model.add(WorldModel.OBSTACLE, 22, 16);
    model.add(WorldModel.OBSTACLE, 22, 17);
    model.add(WorldModel.OBSTACLE, 22, 18);
    model.add(WorldModel.OBSTACLE, 22, 19);    
    model.add(WorldModel.OBSTACLE, 15, 16);
    model.add(WorldModel.OBSTACLE, 15, 17);
    model.add(WorldModel.OBSTACLE, 16, 17);
    model.add(WorldModel.OBSTACLE, 17, 17);
    model.add(WorldModel.OBSTACLE, 18, 17);
    model.add(WorldModel.OBSTACLE, 19, 17);
    model.add(WorldModel.OBSTACLE, 20, 17);
    model.add(WorldModel.OBSTACLE, 15, 18);
    model.add(WorldModel.OBSTACLE, 15, 19);
    model.add(WorldModel.OBSTACLE, 16, 19);
    model.add(WorldModel.OBSTACLE, 17, 19);
    model.add(WorldModel.OBSTACLE, 18, 19);
    model.add(WorldModel.OBSTACLE, 20, 19);
    model.add(WorldModel.OBSTACLE, 21, 19);
    model.add(WorldModel.OBSTACLE, 18, 20);
    model.add(WorldModel.OBSTACLE, 18, 21);
    model.add(WorldModel.OBSTACLE, 19, 21);
    model.add(WorldModel.OBSTACLE, 19, 21);
    model.add(WorldModel.OBSTACLE, 20, 21);
    model.add(WorldModel.OBSTACLE, 21, 21);
    model.add(WorldModel.OBSTACLE, 22, 21);
    model.add(WorldModel.OBSTACLE, 23, 21);
    model.add(WorldModel.OBSTACLE, 24, 21);
    model.add(WorldModel.OBSTACLE, 24, 20);
    model.add(WorldModel.OBSTACLE, 24, 19);
    model.add(WorldModel.OBSTACLE, 24, 18);
    model.add(WorldModel.OBSTACLE, 24, 17);
    model.add(WorldModel.OBSTACLE, 24, 16);
    model.add(WorldModel.OBSTACLE, 24, 15);
    model.add(WorldModel.OBSTACLE, 24, 14);
    model.add(WorldModel.OBSTACLE, 24, 13);
    model.add(WorldModel.OBSTACLE, 23, 13);
...
/**
  ...
  static WorldModel world6() throws Exception
  {
    ...
    {
      if((j<3)||(j>4)){
      	model.add(WorldModel.OBSTACLE, i*8+j, i2*8); 
      	model.add(WorldModel.OBSTACLE, i*8, i2*8+j);
	}	
    }
